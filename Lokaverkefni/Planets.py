...
def key(event):
    ...
    if room == "sR1" or room == "sR2" or room == "sR3":
        ...
        if room == "R1":
            tel = 0
            for a in range(628):
                if Sy > round(900 + 400 * math.sin(tel)) and Sx > round(1200 + 400 * math.cos(tel)): #1200, 900
                    inn = True
...
def R1():
    ...
    planets.append(canvas.create_circle_arc(100, 120, 45, style="arc", outline="white", width=6, start=270 - 25, end=270 + 25))
...
def sR1():
    ...
    planets.append(canvas.create_rectangle(Seatx - 50,Seaty - 50, Seatx + 50,Seaty + 50, fill = "brown",outline = ""))
